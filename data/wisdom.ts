...
export const WISDOMS: Wisdom[] = [
  ...
  // ══════════ สรุปแนวคิด ไม่ใช่คำพูดโดยตรง (verbatim: false) ══════════
  {
    ...
    category: "self",
    avatar: { skin: SKIN, hair: WHITE, hairStyle: "receding", beard: "full", glasses: "round" },
  },
  {
    kind: "quote",
    verbatim: false,
    ...
    category: "courage",
    avatar: { skin: SKIN, hair: GRAY, hairStyle: "receding", glasses: "round" },
  },
  {
    kind: "quote",
    verbatim: false,
    ...
    category: "growth",
    avatar: { skin: SKIN, hair: WHITE, hairStyle: "sides", glasses: "round" },
  },
  {
    kind: "quote",
    verbatim: false,
    ...
    category: "growth",
    avatar: { skin: SKIN, hair: DARK, hairStyle: "full", age: "adult" },
  },
  {
    kind: "quote",
    verbatim: false,
    ...
    category: "courage",
    avatar: { skin: SKIN, hair: WHITE, hairStyle: "sides", glasses: "square" },
  },
  {
    kind: "quote",
    verbatim: false,
  ...
  },
  {
    ...
    category: "self",
    avatar: { skin: SKIN, hair: WHITE, hairStyle: "full", glasses: "square" },
  },
  {
    kind: "quote",
    verbatim: false,
  ...
  },
  {
    ...
    category: "hope",
    avatar: { skin: SKIN, hair: GRAY, hairStyle: "receding", glasses: "square" },
  },
  {
    kind: "quote",
    verbatim: false,
  ...
  },
  {
    ...
    category: "growth",
    avatar: { skin: SKIN, hair: DARK, hairStyle: "bob", collar: "plain" },
  },
  {
    kind: "quote",
    verbatim: false,
  ...
  },
  {
    ...
    category: "acceptance",
    avatar: { skin: SKIN, hair: GRAY, hairStyle: "bob", glasses: "square", collar: "plain" },
  },
  {
    kind: "quote",
    verbatim: false,
