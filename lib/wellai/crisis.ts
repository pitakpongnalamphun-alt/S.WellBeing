...
/** The exact message the spec requires — reproduced verbatim, never paraphrased. */
export const CRISIS_MESSAGE =
  "Well.AI สัมผัสได้ว่าตอนนี้คุณกำลังเจ็บปวดและแบกรับเรื่องหนักหนามาก เราเป็นห่วงคุณมากๆ นะ 💙 เนื่องจาก Well.AI เป็นเพียงระบบ AI จึงอาจช่วยคุณได้ไม่เต็มที่ เราอยากให้คุณได้คุยกับผู้เชี่ยวชาญที่พร้อมรับฟังและช่วยคุณได้ทันที ลองโทรไปที่นี่นะ:\n\n📞 สายด่วนสุขภาพจิต: 1323\n📞 สมาคมสะมาริตันส์: 02-113-6789\n\nมีคนที่พร้อมจะกอดและรับฟังคุณอยู่นะ";
