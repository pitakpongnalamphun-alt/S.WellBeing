 ...
 *
 * ที่แก้จากต้นฉบับมีอย่างเดียวคือชื่อผู้พูด: "Well.AI" → "ปุย" เพราะนักเรียนคุยกับ
 * น้องปุยมาทั้งบทสนทนา ถ้าถึงวินาทีที่เปราะบางที่สุดแล้วมีชื่อแปลกหน้าโผล่ขึ้นมาแทน
...
export const CRISIS_MESSAGE =
  "ปุยสัมผัสได้ว่าตอนนี้คุณกำลังเจ็บปวดและแบกรับเรื่องหนักหนามาก ปุยเป็นห่วงคุณมากๆ นะ 💙 เนื่องจากปุยเป็นเพียงระบบ AI จึงอาจช่วยคุณได้ไม่เต็มที่ ปุยอยากให้คุณได้คุยกับผู้เชี่ยวชาญที่พร้อมรับฟังและช่วยคุณได้ทันที ลองโทรไปที่นี่นะ:\n\n📞 สายด่วนสุขภาพจิต: 1323\n📞 สมาคมสะมาริตันส์: 02-113-6789\n\nมีคนที่พร้อมจะกอดและรับฟังคุณอยู่นะ";
