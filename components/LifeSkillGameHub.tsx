...
const ISLANDS: Island[] = [
  {
    ...
    games: [
      ...
      {
        id: "thought-catcher",
        title: "เกม: จับความคิดที่หลอกเรา",
        blurb: "เรียกชื่อกับดักความคิด แล้วพูดกับตัวเองใหม่แบบไม่หลอกกัน",
        playable: true,
      },
      {
        id: "compare-trap",
        title: "คะแนนเพื่อนขึ้นฟีด",
        blurb: "เทียบกับคนอื่นจนใจแหว่ง — ออกจากวังวนนี้ยังไง",
        playable: true,
      },
      {
        id: "put-it-off",
        title: "เดี๋ยวพรุ่งนี้ค่อยทำ",
        blurb: "ผัดวันไม่ใช่ขี้เกียจ แต่คือการหนีความอึดอัดตอนเริ่มงาน",
        playable: true,
      },
    ],
  },
  {
    ...
    games: [
      ...
      },
      {
        ...
        blurb: "ถูกเทียบกับพี่น้องบนโต๊ะข้าว จะพูดยังไงไม่ให้กลายเป็นทะเลาะ",
        playable: true,
      },
      {
        id: "parents-fight",
        title: "เสียงทะเลาะหลังประตู",
        blurb: "คืนที่พ่อแม่ทะเลาะกัน แล้วเราแอบโทษตัวเอง",
        playable: true,
      },
      {
        id: "phone-privacy",
        title: "แชทที่ถูกเปิดอ่าน",
        blurb: "ต่อรองเรื่องความเป็นส่วนตัวโดยไม่ต้องขึ้นเสียง",
        playable: true,
      },
      {
        id: "money-guilt",
        title: "ค่าเรียนพิเศษที่ไม่กล้าขอ",
        blurb: "ความรู้สึกผิดเรื่องเงินที่เด็กไม่ควรต้องแบกคนเดียว",
        playable: true,
      },
    ],
  },
  {
    ...
    games: [
      ...
      },
      {
        ...
        blurb: "ชอบเพื่อนสนิท แต่กลัวว่าพูดแล้วจะไม่เหมือนเดิม",
        playable: true,
      },
      {
        id: "left-on-read",
        title: "อ่านแล้วไม่ตอบ",
        blurb: "สมองเติมช่องว่างด้วยเรื่องแย่ที่สุดเสมอ",
        playable: true,
      },
      {
        id: "photo-pressure",
        title: "ขอรูปที่ไม่อยากส่ง",
        blurb: "“ถ้ารักกันจริงต้อง…” คือประโยคกดดัน ไม่ใช่ประโยครัก",
        playable: true,
      },
      {
        id: "ex-shadow",
        title: "เงาของคนเก่า",
        blurb: "เทียบตัวเองกับแฟนเก่าคือสนามที่แพ้ตั้งแต่ยังไม่เริ่ม",
        playable: true,
      },
    ],
  },
  {
    ...
    games: [
      ...
      },
      {
        ...
        blurb: "เห็นเพื่อนไปเที่ยวกันโดยไม่ชวน จะจัดการใจยังไง",
        playable: true,
      },
      {
        id: "rumor",
        title: "ข่าวลือที่ไม่จริง",
        blurb: "ยิ่งวิ่งตามแก้ทีละปาก ข่าวลือยิ่งได้อาหาร",
        playable: true,
      },
      {
        id: "friend-in-trouble",
        title: "เพื่อนบอกว่าไม่อยากอยู่แล้ว",
        blurb: "อยู่ข้างเพื่อนยังไง โดยไม่ต้องแบกความลับนี้คนเดียว",
        playable: true,
      },
    ],
  },
  {
    ...
    games: [
      ...
      },
      {
        ...
        blurb: "เช้าที่เปลี่ยนเสื้อสามรอบแล้วยังไม่อยากออกจากบ้าน",
        playable: true,
      },
      {
        id: "cant-say-no",
        title: "รับปากไปหมดจนล้น",
        blurb: "ปฏิเสธไม่เป็นจนตารางแน่นและใจพัง",
        playable: true,
      },
      {
        id: "empty-sunday",
        title: "วันหยุดที่ว่างเปล่า",
        blurb: "ไม่ได้เศร้า แต่ก็ไม่รู้สึกอะไรเลยทั้งวัน",
        playable: true,
      },
      {
        id: "replay-mistake",
